    ...
    return {
        ...
        args = {
            ...
            colorActiveButton={
                ...
                type="color",
                name="Bouttons",
                get = function() return WIDT.db.profile.daily.activeButton.r, WIDT.db.profile.daily.activeButton.g, WIDT.db.profile.daily.activeButton.b; end,
                set = function(info, r, g, b) WIDT.db.profile.daily.activeButton.r = r; WIDT.db.profile.daily.activeButton.g = g; WIDT.db.profile.daily.activeButton.b = b; core.barres.activeButton = WIDT.db.profile.daily.activeButton; end,
            },
